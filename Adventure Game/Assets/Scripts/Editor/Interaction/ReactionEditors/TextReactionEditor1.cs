...
[CustomEditor(typeof(TextReaction1))]
public class TextReactionEditor1 : ReactionEditor
{
    ...
    protected override void DrawReaction()
    {
        ...
        messageProperty.stringValue = 
            EditorGUILayout.TextArea(messageProperty.stringValue, GUILayout.Height(EditorGUIUtility.singleLineHeight * messageGUILines));
